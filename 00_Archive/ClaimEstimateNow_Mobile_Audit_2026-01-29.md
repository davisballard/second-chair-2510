...
- `04_Production/Luke_Wroblewski_(UI_UX_Specialist)/Form_Design_Mastery.md`
- `04_Production/Luke_Wroblewski_(UI_UX_Specialist)/Mobile_First_Framework.md`
- `04_Production/Luke_Wroblewski_(UI_UX_Specialist)/CRO_Methodology.md`
- `04_Production/Chester_Prides_(Web_Designer)/AGENT.md`
- `01_Strategy/Richard_Shotton_(Behavioral_Scientist)/Core_Toolkit.md`
- `01_Strategy/Adam_Ferrier_(Behavioral_Strategist)/The_Advertising_Effect.md`
- `03_Media/Depesh_Mandalia_(Meta_Paid_Social)/Lead_Gen_Playbook.md`
- `_Library/Books/Dont_Make_Me_Think_Steve_Krug.md`
...
*This audit was generated by the Abracadabra system on January 29, 2026.*
