# Second Chair — West Coast Trial Lawyers Market Pricing
...
Every market has a different cost to operate in. Los Angeles has 5,000+ PI firms competing for attention and the strictest advertising compliance regime in the country (SB-37). Bakersfield has a few hundred firms and straightforward at-fault law. The lead quality is the same everywhere — the price reflects what it costs us to reach and qualify people in that specific market.
...
|---|---|---|---|---|---|
| **Los Angeles** | 8.0 | $425 | **$360** | LA, Beverly Hills, Pasadena, Long Beach, Woodland Hills, Newport Beach, Glendora, Santa Ana, Fullerton, West Covina, Valencia, Irvine | 13.2M pop. ~49% Hispanic. Extreme PI competition (5,000+ firms). SB-37 fully active. High uninsured (20.4%). Bilingual creative required. |
| **SF–Oakland–San Jose** | 6.7 | $380 | **$325** | San Francisco, San Jose | 4.7M pop. Tech economy, younger, higher income. Bicycle/rideshare/pedestrian injury patterns. Diverse — Asian, Hispanic, White. |
| **Riverside–San Bernardino** | 5.5 | $340 | **$290** | Riverside, San Bernardino, Palm Springs | 4.7M pop. Inland Empire — working-class, long commutes, I-10/I-15 trucking corridors. ~52% Hispanic. |
| **San Diego** | 5.5 | $340 | **$290** | San Diego, Solana Beach | 3.3M pop. Military presence (Camp Pendleton, Naval bases). Border proximity. ~34% Hispanic. |
| **Sacramento** | 4.7 | $310 | **$265** | Sacramento | 2.7M pop. State capital, government workers. ~23% Hispanic. |
| **Fresno–Visalia** | 3.7 | $270 | **$230** | Fresno, Visalia | 1.1M pop. Central Valley agriculture. ~54% Hispanic. Bilingual creative critical. |
| **Bakersfield** | 3.4 | $260 | **$220** | Bakersfield | 0.9M pop. Oil industry, agriculture, I-5/CA-99 trucking corridor. ~53% Hispanic. |

**California blended (pop-weighted, with lockdown): ~$320/lead**
**CA population covered: 30.6M**
...
|---|---|---|---|---|
| **Las Vegas** | 5.2 | **$325** | Las Vegas, Henderson | 2.3M pop. Service industry workforce, tourism, transient populations. More creative latitude than CA (no SB-37 equivalent). |
| **Reno** | 3.6 | **$270** | Reno, Carson City | 0.5M pop. Same NV advertising latitude. Less competitive than Vegas. |
...
| Market | MOI | Cost Per Lead | WCTL Office Cities | Key Demographics |
|---|---|---|---|---|
| **Phoenix–Mesa** | 4.9 | **$315** | Phoenix | 4.8M pop. Fast-growing metro. Pure comparative fault state. Desert commute/highway accident patterns. |
...
| Market | MOI | Cost Per Lead | WCTL Office Cities | Key Demographics |
|---|---|---|---|---|
| **Seattle–Tacoma** | 5.4 | **$335** | Seattle | 4.6M pop. Pacific Northwest — professional, authentic tone expected. Standard WA RPC rules (no SB-37 equivalent). |
...
Every lead delivered carries a **Projected Attorney Fee** built from its Fit Score × sign probability × median attorney fee by case type. Aggregate across the cohort and divide by spend to get **Projected ROAS** — visible from day one, before any case has signed.

| Market Segment | Approx CPL | Projected Fee per Lead | Projected ROAS |
|---|---|---|---|
...
### CPSC (Alongside Metric, at 10% Sign Rate)

At a conservative 10% lead-to-sign conversion, cost per signed case lands in the following range — alongside the projected ROAS, both numbers improving together as campaigns mature.

| Market Segment | Approx CPL | CPSC @ 10% | Industry Comparable |
|---|---|---|---|
...
**Compliance:** Every lead FCC 2025-compliant with one-to-one consent and TrustedForm audit trail. All California creative built to SB-37 standard — no crash footage, no settlement amount promises, no "get more than you settled for" framing, trusted-advisor tone, mandatory disclosures on every placement, full documentability.

---

*Second Chair — West Coast Trial Lawyers — April 2026*
