# WCTL Arizona — Week 1 Creative Approval Package

**For:** Robert, West Coast Trial Lawyers
**From:** Second Chair
**Date:** 2026-04-28
**Scope:** Week 1 Meta/Facebook creative set — 6 concepts × hook variants, Arizona statewide

---

## What this is

A directional-approval package covering the full Week 1 creative set for the WCTL Arizona pilot. The architecture from the signed proposal stays intact (single consolidated Meta ad set, $7,750 media, 6 launch creatives, quiz funnel + non-soft-tissue qualification). What changed since our April meetings: we went deeper on four personas (Sarah, Diana, Laura, Ty) and produced a **hook-variant matrix** so the ad set can A/B systematically inside Meta's learning phase instead of relying on a single hook per concept.

Every ad in this package is **15 seconds**, built to the same four-beat formula, designed to scroll-stop on Meta/Instagram feeds and Reels, and engineered to pass the AZ Bar ER 7.1 truthfulness standard and Meta's Special Ad Category policy.

---

## The 15-second formula (all 24 units)

| Beat | Seconds | Purpose |
|------|---------|---------|
| **Hook** | 0–3s | First three words either self-qualify the right viewer (identity, severity, or situation) or repel the wrong one. No ambiguity. |
| **Tension** | 3–8s | Emotional or financial stake — why this matters to this person, right now |
| **Turn** | 8–13s | The firm's role, the law's reframe, or the recovery reveal |
| **CTA** | 13–15s | "Free case review" button + phone number micro-CTA |

Three structural variants depending on persona: **PAS** (Problem-Agitate-Solve) for high-intent situational audiences like trucking; **HPR** (Hook-Problem-Reveal) for empathy-driven narrative audiences like pedestrian and MVA; **TTC** (Tension-Turn-Conversion) for visual-tension-driven variants like the motorcycle dramatization. Each concept file (01–06) shows which formula it runs.
...
- **Sat-Sun 2026-05-02/03** — Any revisions produced; final assets locked
- **Sun 2026-05-03 EOD** — 6 primaries submitted to Meta Special Ad Category review (48-hour window)
...
If any of this lands unclear or you want to push on a specific variant before counsel review, call or text Davis directly. We've built the package to be readable in one sitting but there's depth behind every line — happy to walk any of it live.
