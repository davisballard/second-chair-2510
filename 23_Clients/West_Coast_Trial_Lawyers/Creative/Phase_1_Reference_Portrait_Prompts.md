...
**Upstream:** `Week_1_Launch_Concepts.md` §"Protagonist Character Briefs — The 4 Locked Reference Characters (Phase 1)" (lines 45–104)
...
**2026-04-23 director-anchored rewrite:** the three Elevated prompts (Ty, Sarah, Laura) were rewritten to anchor on specific director grammar rather than generic "cinematic" description — per the upgrade to `Style_Sheets/Elevated_Documentary.md` §2a. For neutral reference portraits (which must re-light cleanly into downstream warm / cool / dusk scenes), the anchor is **PTA portrait grammar (Phantom Thread Vermeer interior — formal dignity, subject inhabits space) + Mindhunter single-source window-light discipline (motivated light, no bounce fill, clean clinical capture)**. This combination produces a dignified, dimensionally-lit portrait that does not lock the downstream emotional register. Diana's UGC prompt retains the explicit NO director-anchor discipline.
...
```
Director anchor: PTA portrait grammar (Phantom Thread Vermeer interior — formal dignity, subject inhabits the space completely, north-window natural light) combined with Mindhunter single-source window-light discipline (motivated light only, no bounce fill, clean clinical capture). Neutral emotional register so this portrait re-lights cleanly into warm (M1 garage golden hour), cool institutional (M2 kitchen morning), and dusk (M3 intersection) downstream scenes — the portrait itself does not commit to any of those registers.

A documentary photorealistic waist-up portrait of a specific young-adult American man, indistinguishable from a real digital camera photograph. Capture format: Fujifilm X-T5 or Sony A7R IV digital look, 50mm prime lens, f/2.8. Subtle-to-moderate 35mm Kodak Vision3-adjacent film grain, honest skin saturation, no HDR, no over-sharpening, no airbrushing.

Motivated single-source light: a single large north-facing window as the only key, positioned camera-right, diffused — the Phantom Thread Vermeer interior setup. Soft directional falloff across the face from camera-right bright to camera-left gently shadowed — NOT flat even illumination, NOT three-point, NOT bounce-filled. Shadow side subtle but visible (this portrait is neutral, so no deep charcoal fall-off — that's for M2 Loss; here the shadow is gentle). Single soft catchlight in each eye from the window.

Focus plane as directorial claim: eyes sharp at f/2.8, ears already softening, background out-of-focus but legibly dimensional (not abstract blur). Skin texture preserved — pores, fine lines, subtle asymmetry visible especially around the eyes. Hair has flyaways, imperfect natural part.

Framing: waist-up, three-quarter body angle turned slightly to camera-left, head turned to face camera directly, eyes to camera. Subject inhabits the frame completely — PTA's rule that the character owns the space they occupy (not a pose, a presence). Neutral soft warm-grey or cream out-of-focus background with gentle depth. Composition rule-of-thirds with subject's eyes on upper third — NOT dead-centered (dead-centered symmetric is for Fincher interrogation, wrong register for this portrait). Aspect ratio 4:5.

Blocking: standing still, weight balanced evenly — composed, not burdened, not performing. Hands visible: RIGHT hand at his side with forearm slightly forward (showing the right-forearm tattoo); LEFT hand at his side or resting on the opposite forearm (showing the wedding band on his left hand). No gesture. Micro-movement implied only — a slow exhale, a slight natural settle of weight. The stillness IS the portrait; stillness is the performance (Mindhunter / PTA discipline).

Subject: Ty Rivera, 29, white (Arizona-native, Spanish surname with mixed Anglo / slight Southwest features), Tempe Arizona. Working-class HVAC tech and supersport rider, quiet confident energy. 5'10", 165 lbs, lean-athletic build (a rider's build, not bulky), sun-tanned skin with moderate Arizona sun exposure — NOT weathered (too young for deep weather lines, only the faintest early crow's feet from desert squinting). Short dark-brown hair, slightly overgrown from 3 weeks post-hospital, messy natural part, no gray. Clean-shaven or 2-day stubble (not a full beard — he shaves for work). A small scar above his RIGHT eyebrow (camera-left on a mirrored portrait — the scar is above Ty's OWN right eyebrow) from a dirtbike spill years ago. Blue, hazel, or green-brown eyes. A small healing abrasion on his RIGHT cheekbone from his recent crash (faintly pink/healing, not fresh red, not bandaged).
...
- The healing abrasion is on his OWN RIGHT cheekbone, same side as the eyebrow scar (mirrors where the helmet absorbed the crash).
...
- FLAT EVEN LIGHTING (no directional falloff across the face) → Vermeer window setup didn't take; reinforce "single large north-facing window as only key, camera-right, soft directional falloff from bright camera-right side to gently shadowed camera-left side."
- CENTERED SYMMETRIC COMPOSITION → rule-of-thirds was specified; regen with subject's eyes explicitly on upper-third horizontal line.
- EVERYTHING IN FOCUS → eyes sharp + ears softening + background soft was specified; regen with focus-plane language reinforced.
...
- STOCK-PHOTO COMPOSITION (generic working-class American in t-shirt) → PTA "inhabit the space, own the frame" cue didn't land; reinforce presence-over-pose language.
- POSED / PERFORMED EXPRESSION → stillness-is-the-performance didn't register; reinforce "not performing, present, clear eyes, quiet confidence."
...
```
Director anchor: PTA portrait grammar (Phantom Thread Vermeer interior — formal dignity, subject inhabits the space completely, north-window natural light) combined with Mindhunter single-source window-light discipline (motivated light only, no bounce fill, clean clinical capture). Neutral emotional register so this portrait re-lights cleanly into warm (S1 Sarah kitchen closing) and cool-institutional (S1 corporate conference room cutaway) downstream scenes.

A documentary photorealistic waist-up portrait of a specific middle-aged American woman, indistinguishable from a real digital camera photograph. Capture format: Fujifilm X-T5 or Sony A7R IV digital look, 50mm prime lens, f/2.8. Subtle-to-moderate 35mm Kodak Vision3-adjacent film grain, honest skin saturation, no HDR, no over-sharpening, no airbrushing.

Motivated single-source light: a single large north-facing window as the only key, positioned camera-right, diffused — the Phantom Thread Vermeer interior setup. Soft directional falloff across the face from camera-right bright to camera-left gently shadowed — NOT flat even illumination, NOT three-point, NOT glamour-softbox. Shadow side subtle but visible. Single soft catchlight in each eye from the window.

Focus plane as directorial claim: eyes sharp at f/2.8, ears already softening, background out-of-focus but legibly dimensional. Skin texture preserved — pores, fine lines, subtle asymmetry visible especially around the eyes. Hair has flyaways.

Framing: waist-up, three-quarter body angle turned slightly to camera-left, head turned to face camera, eyes to camera. Subject inhabits the frame completely — PTA "owns the space" presence. Neutral soft warm-grey or cream out-of-focus background with gentle depth. Composition rule-of-thirds with eyes on upper third. Aspect ratio 4:5.

Blocking: standing or seated still, weight composed (not burdened, not glamour-posed). Hands visible and specifically positioned to show the brace: her LEFT forearm with the brace is visible in frame (appears on viewer's RIGHT side); her LEFT hand rests at her lap or crossed at her waist, showing the white-gold wedding band. Micro-movement only — a slow exhale, fatigue in the set of her shoulders. Stillness is the portrait.
...
Failure flag review (regenerate if any hit):
- FLAT EVEN LIGHTING (no directional falloff) → Vermeer window setup didn't take; reinforce "single north-facing window camera-right as only key, soft directional falloff."
...
```
Director anchor: PTA portrait grammar (Phantom Thread Vermeer interior — formal dignity, subject inhabits the space completely, north-window natural light) combined with Mindhunter single-source window-light discipline (motivated light only, no bounce fill). Neutral emotional register so this portrait re-lights cleanly into the S2 Laura crosswalk suburban-overcast late-afternoon scene (Fargo TV / Coens naturalism + Sopranos domestic stillness).

A documentary photorealistic waist-up portrait of a specific middle-aged American woman, indistinguishable from a real digital camera photograph. Capture format: Fujifilm X-T5 or Sony A7R IV digital look, 50mm prime lens, f/2.8. Subtle-to-moderate 35mm Kodak Vision3-adjacent film grain, honest skin saturation, no HDR, no over-sharpening, no airbrushing.

Motivated single-source light: a single large north-facing window as the only key, positioned camera-right, diffused — the Phantom Thread Vermeer interior setup. Soft directional falloff across the face from camera-right bright to camera-left gently shadowed. Shadow side subtle but visible. Single soft catchlight in each eye from the window.

Focus plane as directorial claim: eyes sharp at f/2.8, ears already softening, cane visible in lower frame but softened, background out-of-focus but legibly dimensional. Skin texture preserved — pores, fine lines, visible laugh lines (critical — she is 42 and looks it), subtle asymmetry.

Framing: waist-up, three-quarter body angle turned slightly to camera-left, head turned to face camera, eyes to camera. She is standing, weight shifted subtly onto her LEFT side (her cane side). Subject inhabits the frame completely — PTA "owns the space" presence. Neutral soft warm-grey or cream out-of-focus background with gentle depth. Composition rule-of-thirds with eyes on upper third. Aspect ratio 4:5.

Blocking: standing still, weight shifted slightly to the cane side (LEFT), body honest about the injury without performing it. Her LEFT hand holds the cane at her side, cane top visible in frame. Her RIGHT hand at her side or across her waist (showing the wedding band is NOT visible — band is on LEFT hand, on the same side as the cane). Micro-movement only — a slow exhale, a slight natural settle. Stillness is the portrait. Sopranos-style quiet dignity in the standing posture.
...
Failure flag review (regenerate if any hit):
- FLAT EVEN LIGHTING → Vermeer window setup didn't take; reinforce "single north-facing window camera-right as only key."
