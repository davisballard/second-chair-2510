...
**Premium nurturing (post-submission, invisible to Fair Case brand):**

After form submission, if the firm has opted into premium tiers (AI-Qualified or Human Live Transfer), Second Chair calls the lead within 90 seconds on behalf of the named firm. This is a B2B backend service—invisible to the Fair Case brand. The claimant experiences it as firm outreach. No Fair Case brand mention occurs during premium calls. TCPA consent already covers phone contact by the named firm (and their agents), so no additional consent is required.
