...
## Outreach Priority 1: Multi-Market Mega-Firms (Whale of Whales)
...
1. **SpyFu:** Search PI keywords in multiple metros → find same domain appearing across cities
2. **Best Lawyers:** Filter firms ranked in multiple metros simultaneously
3. **Google Maps:** Same firm name appearing in 3+ city searches
4. **Apollo.io:** Search by firm domain → see all office locations listed
5. **Spanish-Capable PI Firms list:** Already identified multi-state firms like Jacoby & Meyers (CA, NY, FL)
6. **Whale lists:** Cross-reference NYC and Miami whale lists for firms that appear in both

### Outreach Approach

Sasha hand-crafts every one of these. The pitch references their multi-market presence directly:
...
| 3 | **New York** | 8.4 | $24K-$44K/mo | Sasha is local | Open |
| 4 | **Miami** | 8.1 | $20K-$36K/mo | Whale list pre-built | Open |
| 5 | **San Francisco** | 7.8 | $16K-$28K/mo | Davis nearby | Open |
| 6 | **Dallas-Ft Worth** | 7.7 | $20K-$32K/mo | — | Open |
| 7 | **Houston** | 7.5 | $20K-$36K/mo | — | Open |
| 8 | **Chicago** | 7.4 | $20K-$32K/mo | — | Open |
| 9 | **San Diego** | 7.2 | $12K-$20K/mo | Davis nearby | Open |
| 10 | **Philadelphia** | 7.0 | $16K-$24K/mo | Sasha nearby | Open |
...
| **Texas** | 9/10 | $300-$375/lead | $20K-$30K/mo | San Antonio, Austin, El Paso |
| **New York** | 9/10 | $375-$450/lead | $30K-$40K/mo | Upstate (Buffalo, Albany, Syracuse) |
| **Illinois** | 8/10 | $300-$375/lead | $15K-$25K/mo | (Chicago-centric, limited expansion) |
| **New Jersey** | 8/10 | $300-$375/lead | $15K-$20K/mo | Full state (NYC proximity pricing) |
| **Pennsylvania** | — | — | $16K-$24K/mo | Pittsburgh |
| **Massachusetts** | — | — | — | Boston metro |
| **Georgia** | — | — | — | (Already covered via Atlanta) |
...
### Tier 0 — Multi-Market Mega-Firms (NEW — Highest Priority)
...
- Named in Best Lawyers / Super Lawyers rankings
- Running Google Ads for PI keywords (SpyFu confirmed)
- Managing partner or marketing director identifiable
...
**Criteria:**
- 3-10 attorneys
- $3M-$10M estimated annual revenue
- Active Google Business Profile with reviews
- Identifiable managing partner
...
### Tier 3 — Mass Outreach (Template-Based)

**Criteria:**
- 1-2 attorneys / solo practitioners
- <$3M estimated revenue
- From bulk directory scrape (Google Maps, Avvo, etc.)
...
- **Any prospect who responds** → immediately Tier 1 treatment regardless of original tier
- **Any Tier 2/3 firm discovered to have multi-market offices** → immediately Tier 0

---

## Persona Quick Reference

| Persona | Firm Profile | Pain Point | Hot Button | Sales Cycle |
|---------|-------------|------------|------------|-------------|
| **Tony Reyes (Hungry Solo)** | 1-3 attorneys, <$3M revenue | Inconsistent leads, cash flow | Cost per signed case, exclusivity | 1-2 weeks |
| **Jennifer Walsh (Established Builder)** | 10-25 attorneys, growth mode | Scaling profitably, mega-firm competition | Exclusive territory, competitive edge | 2-4 weeks |
| **The Tired King** | Pre-retirement partner, 55-65 | Wants predictability, not chaos | Turnkey solution, protect practice value | 1-2 weeks |
| **Marcus Chen (Marketing Director)** | 50+ attorneys, $100M+ | Justifying spend, proving ROI | Transparent reporting, data/metrics | 4-8 weeks |

**Sweet spot:** Jennifer Walsh — fastest to close at meaningful deal size.

---

## Prioritization Logic (Weekly Prospect List)

When building the weekly outreach queue:

1. **Tier 0: Multi-market firms** — always first, always Sasha
2. **Firms running Google Ads** (SpyFu) — proven ad buyers, highest conversion likelihood
3. **Firms in Best Lawyers / U.S. News Tier 1** — budget and prestige confirmed
