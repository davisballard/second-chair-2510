...
| Expert | Role | File |
|--------|------|------|
| **Julian Cole** | Head of Strategy — Strategic frame, comms architecture | `01_Strategy/Julian_Cole_(Head_of_Strategy)/AGENT.md` |
| **Richard Shotton** | Behavioral Scientist — Psychological levers, biases to exploit | `01_Strategy/Richard_Shotton_(Behavioral_Scientist)/AGENT.md` |
| **Ed McCabe** | Senior Copywriter — Headlines, hooks, copy craft | `02_Creative/Ed_McCabe_(Senior_Copywriter)/AGENT.md` |
